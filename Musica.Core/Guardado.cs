...
namespace Musica.Core
{
    public class Guardado
    {
        ...
        static readonly List<Artista> artistas = new List<Categoria>();
        public static IEnumerable<Artista> Artistas
            => artistas;
        public static Artista GetArtista(int id)
            => artistas.Find(c => c.Id == id);
        public static void GuardarArtistas(Artista artista)
        {
        ...
        public static void GuardarArtista(Artista artista)
            => artistas.RemoveAll(c => c.Id == artista.Id);
        ...
        public static IEnumerable<Album> album
            => artistas.SelectMany(c => c.albumes);
        ...
        public static IEnumerable<Cancion> Canciones
            => albumes.SelectMany(c => c.Canciones);
        ...
        public static Cancion GetCancion(int id)
            => Canciones.First(p => p.Id == id);
    }
}
